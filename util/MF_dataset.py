...
class MF_dataset(Dataset):
    ...
    def __init__(self, data_dir, split, input_h=480, input_w=640 ,transform=[]):
        ...
        #assert split in ['train', 'val', 'test', 'test_day', 'test_night', 'val_test', 'most_wanted', 'train_day', 'train_night','subtrain'], \
        #    'split must be "train"|"val"|"test"|"test_day"|"test_night"|"val_test"|"most_wanted"|"train_day"|"train_night"|"subtrain"'  # test_day, test_night
