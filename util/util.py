...
def visualize(image_name, predictions, model_name):
    palette = get_palette()
    for (i, pred) in enumerate(predictions):
        ...
        save_dir = '/home/zhangyulan/RGBT-master/real-time-master/pict/' + model_name+'pst'
        if os.path.exists(save_dir) is False:
            os.makedirs(save_dir)
        img.save(save_dir+ '/' + image_name[i] + '.png')
